...
npm-install:
	...
	-w /usr/src/app \
	node:10 /bin/bash -ci "npm install && npm run production"
...
npm-install-dev:
	...
	-v $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST))))/src:/usr/src/app \
	-w /usr/src/app \
	node:10 /bin/bash -ci "npm install && npm run dev"
...
npm-ls:
	...
	-v $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST))))/src:/usr/src/app \
	-w /usr/src/app \
	node:10 /bin/bash -ci "npm ls $(module)"
...
npm-outdated:
	...
	-v $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST))))/src:/usr/src/app \
	-w /usr/src/app \
	node:10 /bin/bash -ci "npm outdated"
...
mix:
	...
	-v $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST))))/src:/usr/src/app \
	-w /usr/src/app \
	node:10 /bin/bash -ci "npm run production"
