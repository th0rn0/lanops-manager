  ...
  <div class="col-lg-8">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        {{ Form::open(array('url'=>'/admin/venues/' . $venue->id, 'files' => 'true')) }}
      ...
      <div class="panel-body">
        @foreach($venue->images as $image)
          <div class="row">
            ...
            <div class="col-lg-12 col-sm-12">
              <br>
              {{ Form::open(array('url'=>'/admin/venues/' . $venue->id . '/' . $image->id, 'files' => 'true')) }}
                <div class="form-group">
              ...
              {{ Form::close() }}
              <hr>
              {{ Form::open(array('url'=>'/admin/venues/' . $venue->id . '/' . $image->id, 'onsubmit' => 'return ConfirmDelete()')) }}
                {{ Form::hidden('_method', 'DELETE') }}
                <button type="submit" class="btn btn-danger">Delete</button>
              {{ Form::close() }}
            </div>
