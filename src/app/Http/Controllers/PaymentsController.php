        ...
        switch ($paymentGateway) {
            case 'stripe':
                ...
                $rules = [
                    ...
                    'card_expiry_month' => 'required|integer|size:2',
                    'card_expiry_year'  => 'required|integer|size:2',
                    'card_cvv'          => 'integer|size:3',
                ...
                $messages = [
                    ...
                    'card_expiry_month.size'        => 'Expiry Month Must in the MM format',
                    'card_expiry_year.required'     => 'Expiry Year is Required',
                    'card_expiry_year.integer'      => 'Expiry Year Must be a Number',
                    'card_expiry_year.size'         => 'Expiry Year Must in the YY format',
                    'card_cvv.integer'              => 'CVV must be a Number',
                    'card_cvv.size'                 => 'CVV must be a 3 Digits long',
