				...
				{{ Form::open(array('url'=>'/admin/events/' . $event->slug . '/tournaments/' . $tournament->slug )) }}
					...
					@if ($tournament->status != 'COMPLETE')
						...
						<div class="form-group">
							...
							<div>
								<small>Make sure to select a game where the in the <a href="/admin/games">settings</a> selected gamematchapihandler supports the Autoapi feature! (Get5,SharpTournament)</small>
							</div>
						</div>
						<div class="form-group">
