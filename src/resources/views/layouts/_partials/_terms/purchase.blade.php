<div>
    ...
    <ol>
        <li>Intentionally or unintentionally causing damage to another attendee's system; We recommend that you do not touch other attendees' equipment, thereby limiting the potential of being accused of something</li>
        <li>Damaging another attendees or LanOps equipment/property, causing damage to the venue or the equipment there; This includes any actions that could prevent LanOps from hosting another event at the venue</li>
        <li>Failing to comply with the wishes of the LanOps staff and/or venue owner's staff. You will be held responsible for repayment to LanOps of any monies paid by LanOps to the venue owners or any other persons for the repair/replacement of any equipment/property damaged by you</li>
    </ol>
    <p>
        <strong>Cheating in any way, shape or form is deemed unacceptable.</strong> Any persons found to be cheating will be asked to leave the event without any reimbursement of entry fees. Cheating is considered but is not limited to any of the following:
    </p>
    <ol>
        <li>Use of any code or script that causes the player to have an unfair advantage over others</li>
        <li>Disrupting the network or game servers to provide an advantage</li>
        <li>Manipulating a games netcode / packets to mislead the game or server into misreporting your position, actions or ping</li>
    </ol>
    <p>
    ...
    <ol>
        <li>All pirated software</li>
        <li>Pornographic images/media/software</li>
        <li>Viruses</li>
    </ol>
    <p>
    ...
    <p>
        <strong>LanOps staff's decision is final.</strong> No correspondence will be entered into.
    </p>
    <p>
