<div class="news-post">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6">
			...
			<p class="news-post-meta pull-right">{{ date('F d, Y', strtotime($newsArticle->created_at)) }} by <a href="#">{{ $newsArticle->user->steamname }}</a><span class="hidden-xs"> | Comments: {{ $newsArticle->comments->count() }}</span></p>
		</div>
	</div>
</div><br>